      ...
      >
        {contentToScroll.map((blogPost, index) => (
          <div 
            ...
            // Adjusted widths to show 1 card on xs, 2 on sm, 3 on md and larger
            className="flex-shrink-0 w-full sm:w-[calc(50%-1rem)] md:w-[calc(33.33%-1.33rem)] lg:w-[calc(33.33%-1.33rem)]"
          >
            <BlogCard
              post={{
                ...blogPost,
